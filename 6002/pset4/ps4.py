...
if __name__ == "__main__":
    print(r_squared([0.95, 2.01, 3.05], [1, 2, 3]))
...
def evaluate_models_on_training(x, y, models):
    ...
    es = a*xs + b
    r2 = r_squared(y, es)
    pylab.title("Model of a=" + str(round(a, 4)) + " b=" + str(round(b, 4)) + "\n" 
                + "R2=" + str(round(r2, 4)))
    pylab.xlabel("Years")
    pylab.ylabel("Temperature in degree")
    pylab.plot(xs, ys, 'bo')
    pylab.plot(xs, es, 'r', label="Linear fit")
    pylab.show()


### Begining of program
raw_data = Climate('6002/pset4/data.csv')
